...
//! Test script to verify voice command recording functionality
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match start_cmd.execute(start_params, &mut context) {
        Ok(result) => {
    ...
    match stop_cmd.execute(stop_params, &mut context) {
        Ok(result) => {
